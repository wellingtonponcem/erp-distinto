...
<div class="theme-filmmaker">
    ...
    <section class="proposal-page" style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.8)), url('https://images.unsplash.com/photo-1492691523567-6170f0295dbd?auto=format&fit=crop&q=80&w=1200'); background-size: cover; background-position: center;">
        <div style="padding: 80px; flex: 1; display: flex; flex-direction: column; justify-content: center;">
        ...
        <div style="padding: 40px 80px; display: flex; justify-content: space-between; align-items: center; border-top: 1px solid rgba(255,255,255,0.1);">
    ...
    <section class="proposal-page">
        <div style="padding: 80px; flex: 1; display: grid; grid-template-columns: 1fr 1fr; gap: 80px; align-items: center;">
            <div>
    ...
    <section class="proposal-page" style="justify-content: center; align-items: center; text-align: center;">
